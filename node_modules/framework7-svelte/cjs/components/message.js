/* message.svelte generated by Svelte v3.29.4 */
"use strict";

const { HtmlTag, SvelteComponent, append, assign, attr, check_outros, compute_rest_props, create_slot, detach, element, empty, exclude_internal_props, get_spread_update, group_outros, init, insert, listen, run_all, safe_not_equal, set_attributes, set_data, space, text: text_1, transition_in, transition_out, update_slot } = require("svelte/internal");
...
// (109:4) {#if (hasHeaderSlots || header)}
...
// (125:6) {#if (hasTextHeaderSlots || textHeader)}
...
// (131:6) {#if (hasTextSlots || text || htmlText || typing)}
...
// (145:6) {#if (hasTextFooterSlots || textFooter)}
...
// (154:4) {#if (hasFooterSlots || footer)}
