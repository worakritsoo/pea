/* fab.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, action_destroyer, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_slot, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, is_function, listen, run_all, safe_not_equal, set_attributes, set_data, space, text: text_1, transition_in, transition_out, update_slot } = require("svelte/internal");
const { createEventDispatcher, onMount, afterUpdate } = require("svelte");
...
// (80:4) {#if typeof text !== 'undefined' || hasTextSlots}
...
function create_fragment(ctx) {
	...
	let if_block = (typeof /*text*/ ctx[2] !== "undefined" || /*hasTextSlots*/ ctx[10]) && create_if_block(ctx);
	...
	return {
		c() {
			...
			attr(a, "href", /*hrefComputed*/ ctx[9]);
		...
		p(ctx, [dirty]) {
			...
			if (typeof /*text*/ ctx[2] !== "undefined" || /*hasTextSlots*/ ctx[10]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*text, hasTextSlots*/ 1028) {
			...
			if (!current || dirty & /*hrefComputed*/ 512) {
				attr(a, "href", /*hrefComputed*/ ctx[9]);
			}
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*href*/ 32768) {
			$: $$invalidate(9, hrefComputed = href === true ? "#" : href || undefined);
		}
	...
	$: $$invalidate(10, hasTextSlots = hasSlots(arguments, "text"));
