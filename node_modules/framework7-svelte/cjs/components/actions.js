/* actions.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, assign, binding_callbacks, compute_rest_props, create_slot, detach, element, exclude_internal_props, get_spread_update, init, insert, safe_not_equal, set_attributes, transition_in, transition_out, update_slot } = require("svelte/internal");
...
const { modalStateClasses } = require("../shared/modal-state-classes");
...
function instance_1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$new_props => {
		...
		if ("grid" in $$new_props) $$invalidate(6, grid = $$new_props.grid);
		if ("convertToPopover" in $$new_props) $$invalidate(7, convertToPopover = $$new_props.convertToPopover);
		if ("forceToPopover" in $$new_props) $$invalidate(8, forceToPopover = $$new_props.forceToPopover);
	...
	$$self.$$.update = () => {
		$: $$invalidate(1, classes = classNames(className, "actions-modal", { "actions-grid": grid }, modalStateClasses(state), colorClasses($$props)));
