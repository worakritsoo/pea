/* actions-button.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_slot, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, listen, safe_not_equal, set_attributes, space, transition_in, transition_out, update_slot } = require("svelte/internal");
...
exports.default = Actions_button;