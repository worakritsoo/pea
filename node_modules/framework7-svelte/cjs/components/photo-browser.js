/* photo-browser.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, assign, exclude_internal_props, init: init_1, safe_not_equal } = require("svelte/internal");
const { createEventDispatcher, onMount, onDestroy } = require("svelte");
const { extend, createEmitter } = require("../shared/utils");
