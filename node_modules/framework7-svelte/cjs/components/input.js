/* input.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, empty, exclude_internal_props, get_spread_object, get_spread_update, group_outros, init, insert, listen, mount_component, noop, run_all, safe_not_equal, select_option, select_options, set_attributes, set_data, space, text, transition_in, transition_out, update_slot } = require("svelte/internal");
const { createEventDispatcher, onMount, afterUpdate, onDestroy } = require("svelte");
const { colorClasses } = require("../shared/mixins");
const { classNames, createEmitter } = require("../shared/utils");
...
const { default: Range } = require("./range");
...
function create_if_block_10(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			/*textarea_binding_1*/ ctx[62](textarea);
		...
		d(detaching) {
			...
			/*textarea_binding_1*/ ctx[62](null);
			mounted = false;
			run_all(dispose);
		}
	};
...
function create_if_block_9(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			/*select_binding_1*/ ctx[61](select);
			current = true;
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && dirty[1] & /*$$scope*/ 33554432) {
					update_slot(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[56], dirty, null, null);
				}
			}
...
function create_if_block_5(ctx) {
	...
	return {
		...
		m(target, anchor) {
			insert(target, textarea, anchor);
			/*textarea_binding*/ ctx[59](textarea);
...
// (466:4) {#if (errorMessage || hasErrorSlots) && errorMessageForce}
function create_if_block_3(ctx) {
	let div;
	let t0;
	let t1;
	let current;
	const error_message_slot_template = /*#slots*/ ctx[57]["error-message"];
	const error_message_slot = create_slot(error_message_slot_template, ctx, /*$$scope*/ ctx[56], get_error_message_slot_context);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (error_message_slot) {
				if (error_message_slot.p && dirty[1] & /*$$scope*/ 33554432) {
					update_slot(error_message_slot, error_message_slot_template, ctx, /*$$scope*/ ctx[56], dirty, get_error_message_slot_changes, get_error_message_slot_context);
				}
			}
		},
		i(local) {
...
// (473:4) {#if info || hasInfoSlots}
function create_if_block_1(ctx) {
	let div;
	let t0;
	let t1;
	let current;
	const info_slot_template = /*#slots*/ ctx[57].info;
	const info_slot = create_slot(info_slot_template, ctx, /*$$scope*/ ctx[56], get_info_slot_context);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (info_slot) {
				if (info_slot.p && dirty[1] & /*$$scope*/ 33554432) {
					update_slot(info_slot, info_slot_template, ctx, /*$$scope*/ ctx[56], dirty, get_info_slot_changes, get_info_slot_context);
				}
			}
		},
		i(local) {
...
function instance($$self, $$props, $$invalidate) {
	...
	function validateInput() {
		...
		if (!validity.valid) {
			...
			if (inputInvalid !== true) {
				$$invalidate(65, inputInvalid = true);
			}
		} else {
			if (onValidate) onValidate(true);

			if (inputInvalid !== false) {
				$$invalidate(65, inputInvalid = false);
			}
		}
	}
	...
	function onFocus(...args) {
		emit("focus", [...args]);
		$$invalidate(64, inputFocused = true);
	}
	...
	function onBlur(...args) {
		...
		$$invalidate(64, inputFocused = false);
	}
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*resizable, errorMessage*/ 1342177280 | $$self.$$.dirty[1] & /*wrap, className, inputType, noFormStoreData, noStoreData, ignoreStoreData, errorMessageForce*/ 1900581 | $$self.$$.dirty[2] & /*inputInvalid, inputFocused*/ 12) {
	...
	$: $$invalidate(41, hasErrorSlots = hasSlots(arguments, "error-message"));
