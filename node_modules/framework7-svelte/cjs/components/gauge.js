/* gauge.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, compute_rest_props, detach, element, empty, exclude_internal_props, get_spread_update, init, insert, noop, safe_not_equal, set_attributes, set_data, svg_element, text } = require("svelte/internal");
const { classNames } = require("../shared/utils");
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(text_1, "x", "50%");
			attr(text_1, "y", text_1_y_value = /*semiCircle*/ ctx[14] ? "100%" : "50%");
			...
			attr(text_1, "dy", text_1_dy_value = /*semiCircle*/ ctx[14]
			? /*labelText*/ ctx[9]
			...
			attr(text_1, "dominant-baseline", text_1_dominant_baseline_value = !/*semiCircle*/ ctx[14] ? "middle" : null);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*semiCircle*/ 16384 && text_1_y_value !== (text_1_y_value = /*semiCircle*/ ctx[14] ? "100%" : "50%")) {
			...
			if (dirty & /*semiCircle, labelText, labelFontSize*/ 18944 && text_1_dy_value !== (text_1_dy_value = /*semiCircle*/ ctx[14]
			? /*labelText*/ ctx[9]
				? -/*labelFontSize*/ ctx[11] - 15
				: -5
			: 0)) {
			...
			if (dirty & /*semiCircle*/ 16384 && text_1_dominant_baseline_value !== (text_1_dominant_baseline_value = !/*semiCircle*/ ctx[14] ? "middle" : null)) {
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*semiCircle, valueText, valueFontSize*/ 16544 && text_1_dy_value !== (text_1_dy_value = /*semiCircle*/ ctx[14]
			? -5
			: /*valueText*/ ctx[5]
				? /*valueFontSize*/ ctx[7] / 2 + 10
				: 0)) {
...
function create_fragment(ctx) {
	...
	let if_block0 = /*semiCircle*/ ctx[14] && create_if_block_4(ctx);
	let if_block1 = !/*semiCircle*/ ctx[14] && create_if_block_2(ctx);
	let if_block2 = /*valueText*/ ctx[5] && create_if_block_1(ctx);
	let if_block3 = /*labelText*/ ctx[9] && create_if_block(ctx);
	let div_levels = [{ class: /*classes*/ ctx[13] }, restProps(/*$$restProps*/ ctx[18])];
	let div_data = {};
	...
	return {
		c() {
			...
			attr(svg, "height", svg_height_value = `${/*semiCircle*/ ctx[14]
			? /*size*/ ctx[0] / 2
			: /*size*/ ctx[0]}px`);

			attr(svg, "viewBox", svg_viewBox_value = `0 0 ${/*size*/ ctx[0]} ${/*semiCircle*/ ctx[14]
			? /*size*/ ctx[0] / 2
			: /*size*/ ctx[0]}`);
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*semiCircle, size*/ 16385 && svg_height_value !== (svg_height_value = `${/*semiCircle*/ ctx[14]
			? /*size*/ ctx[0] / 2
			: /*size*/ ctx[0]}px`)) {
				attr(svg, "height", svg_height_value);
			}

			if (dirty & /*size, semiCircle*/ 16385 && svg_viewBox_value !== (svg_viewBox_value = `0 0 ${/*size*/ ctx[0]} ${/*semiCircle*/ ctx[14]
			? /*size*/ ctx[0] / 2
			: /*size*/ ctx[0]}`)) {
			...
			set_attributes(div, div_data = get_spread_update(div_levels, [
				dirty & /*classes*/ 8192 && { class: /*classes*/ ctx[13] },
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*className*/ 524288) {
			$: $$invalidate(13, classes = classNames(className, "gauge"));
		}

		if ($$self.$$.dirty & /*type*/ 1048576) {
			$: $$invalidate(14, semiCircle = type === "semicircle");
		}

		if ($$self.$$.dirty & /*size, borderWidth*/ 17) {
			$: $$invalidate(15, radius = size / 2 - borderWidth / 2);
		}

		if ($$self.$$.dirty & /*radius*/ 32768) {
