/* toolbar.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_slot, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, safe_not_equal, set_attributes, space, transition_in, transition_out, update_slot } = require("svelte/internal");
...
const { setReactiveContext } = require("../shared/set-reactive-context");
...
function create_fragment(ctx) {
	...
	const before_inner_slot = create_slot(before_inner_slot_template, ctx, /*$$scope*/ ctx[22], get_before_inner_slot_context);
	...
	const after_inner_slot = create_slot(after_inner_slot_template, ctx, /*$$scope*/ ctx[22], get_after_inner_slot_context);
		...
		p(ctx, [dirty]) {
			if (before_inner_slot) {
				if (before_inner_slot.p && dirty & /*$$scope*/ 4194304) {
					update_slot(before_inner_slot, before_inner_slot_template, ctx, /*$$scope*/ ctx[22], dirty, get_before_inner_slot_changes, get_before_inner_slot_context);
				}
			}
			...
			if (after_inner_slot) {
				if (after_inner_slot.p && dirty & /*$$scope*/ 4194304) {
					update_slot(after_inner_slot, after_inner_slot_template, ctx, /*$$scope*/ ctx[22], dirty, get_after_inner_slot_changes, get_after_inner_slot_context);
				}
			}
