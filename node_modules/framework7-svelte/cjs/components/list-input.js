/* list-input.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, empty, exclude_internal_props, get_spread_object, get_spread_update, group_outros, init, insert, listen, mount_component, noop, run_all, safe_not_equal, select_option, set_attributes, set_data, space, text, transition_in, transition_out, update_slot } = require("svelte/internal");
const { createEventDispatcher, onMount, afterUpdate, onDestroy } = require("svelte");
const { colorClasses } = require("../shared/mixins");
const { classNames, extend, plainText, createEmitter } = require("../shared/utils");
...
const { default: TextEditor } = require("./text-editor");
...
function create_else_block_1(ctx) {
	...
	let if_block1 = (/*media*/ ctx[1] || /*hasMediaSlots*/ ctx[44]) && create_if_block_21(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (/*media*/ ctx[1] || /*hasMediaSlots*/ ctx[44]) {
				if (if_block1) {
					if_block1.p(ctx, dirty);

					if (dirty[0] & /*media*/ 2 | dirty[1] & /*hasMediaSlots*/ 8192) {
...
function create_if_block(ctx) {
	...
	const root_start_slot = create_slot(root_start_slot_template, ctx, /*$$scope*/ ctx[72], get_root_start_slot_context);
	const content_start_slot_template = /*#slots*/ ctx[73]["content-start"];
	...
	let if_block1 = (/*media*/ ctx[1] || /*hasMediaSlots*/ ctx[44]) && create_if_block_10(ctx);
	const inner_start_slot_template = /*#slots*/ ctx[73]["inner-start"];
	...
	let if_block6 = (typeof /*info*/ ctx[35] !== "undefined" || /*hasInfoSlots*/ ctx[43]) && create_if_block_2(ctx);
	const inner_slot_template = /*#slots*/ ctx[73].inner;
	...
	let if_block7 = /*isSortable*/ ctx[39] && !/*isSortableOpposite*/ ctx[40] && create_if_block_1(ctx);
	const root_slot_template = /*#slots*/ ctx[73].root;
	const root_slot = create_slot(root_slot_template, ctx, /*$$scope*/ ctx[72], get_root_slot_context);
	const root_end_slot_template = /*#slots*/ ctx[73]["root-end"];
	const root_end_slot = create_slot(root_end_slot_template, ctx, /*$$scope*/ ctx[72], get_root_end_slot_context);
		...
		p(ctx, dirty) {
			if (root_start_slot) {
				if (root_start_slot.p && dirty[2] & /*$$scope*/ 1024) {
					update_slot(root_start_slot, root_start_slot_template, ctx, /*$$scope*/ ctx[72], dirty, get_root_start_slot_changes, get_root_start_slot_context);
				}
			}
			...
			if (root_slot) {
				if (root_slot.p && dirty[2] & /*$$scope*/ 1024) {
					update_slot(root_slot, root_slot_template, ctx, /*$$scope*/ ctx[72], dirty, get_root_slot_changes, get_root_slot_context);
				}
			}

			if (root_end_slot) {
				if (root_end_slot.p && dirty[2] & /*$$scope*/ 1024) {
					update_slot(root_end_slot, root_end_slot_template, ctx, /*$$scope*/ ctx[72], dirty, get_root_end_slot_changes, get_root_end_slot_context);
				}
			}
...
// (558:4) {#if isSortable && isSortableOpposite}
...
// (564:8) {#if typeof media !== 'undefined'}
...
// (570:6) {#if typeof label !== 'undefined' || hasLabelSlots}
...
function create_else_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*type*/ 16 | dirty[1] & /*inputValue*/ 2048 && input_1_value_value !== (input_1_value_value = /*type*/ ctx[4] === "datepicker" || /*type*/ ctx[4] === "colorpicker" || /*type*/ ctx[4] === "file"
			? ""
...
// (704:8) {#if hasErrorMessage && errorMessageForce}
...
// (711:8) {#if typeof info !== 'undefined' || hasInfoSlots}
...
// (529:10) {#if hasErrorMessage && errorMessageForce}
...
// (536:10) {#if typeof info !== 'undefined' || hasInfoSlots}
...
// (549:4) {#if isSortable && !isSortableOpposite}
...
function instance($$self, $$props, $$invalidate) {
	...
	let ListContext = getReactiveContext("ListContext", newValue => {
		$$invalidate(85, ListContext = newValue || {});
	}) || {};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[1] & /*sortable*/ 134217728 | $$self.$$.dirty[2] & /*ListContext*/ 8388608) {
			$: $$invalidate(39, isSortable = sortable || ListContext.listIsSortable);
		}

		if ($$self.$$.dirty[1] & /*sortableOpposite*/ 268435456 | $$self.$$.dirty[2] & /*ListContext*/ 8388608) {
			$: $$invalidate(40, isSortableOpposite = sortableOpposite || ListContext.listIsSortableOpposite);
		}
		...
		if ($$self.$$.dirty[1] & /*errorMessage*/ 4 | $$self.$$.dirty[2] & /*hasErrorSlots*/ 67108864) {
	...
	$: $$invalidate(88, hasErrorSlots = hasSlots(arguments, "error-message"));
