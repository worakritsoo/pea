/* nav-left.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, mount_component, safe_not_equal, set_attributes, space, transition_in, transition_out, update_slot } = require("svelte/internal");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*needBackLinkText, theme*/ 12288) {
			$: if (typeof needBackLinkText === "undefined") $$invalidate(13, needBackLinkText = theme && !theme.md);
		}
