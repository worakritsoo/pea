/* stepper.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, compute_rest_props, detach, element, exclude_internal_props, get_spread_update, init: init_1, insert, listen, noop, run_all, safe_not_equal, set_attributes, set_data, space, text } = require("svelte/internal");
const { createEventDispatcher, onMount, onDestroy } = require("svelte");
const { colorClasses } = require("../shared/mixins");
const { classNames, noUndefinedProps, plainText, createEmitter } = require("../shared/utils");
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*input*/ ctx[6] && !/*buttonsOnly*/ ctx[9] && create_if_block_1(ctx);
	let if_block1 = !/*input*/ ctx[6] && !/*buttonsOnly*/ ctx[9] && create_if_block(ctx);
