/* card.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, mount_component, safe_not_equal, set_attributes, set_data, space, text, transition_in, transition_out, update_slot } = require("svelte/internal");
...
const { default: CardHeader } = require("./card-header");
const { default: CardContent } = require("./card-content");
const { default: CardFooter } = require("./card-footer");
...
// (143:2) {#if typeof title !== 'undefined' || hasHeaderSlots}
...
// (149:2) {#if typeof content !== 'undefined' || hasContentSlots}
...
// (155:2) {#if typeof footer !== 'undefined' || hasFooterSlots}
