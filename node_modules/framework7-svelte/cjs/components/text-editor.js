/* text-editor.svelte generated by Svelte v3.29.4 */
"use strict";
...
function instance_1($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		$: $$invalidate(1, classes = classNames(className, "text-editor", resizable && "text-editor-resizable", colorClasses($$props)));
