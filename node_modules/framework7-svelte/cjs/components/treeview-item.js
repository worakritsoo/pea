/* treeview-item.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, listen, mount_component, safe_not_equal, set_attributes, set_data, space, text, transition_in, transition_out, update_slot } = require("svelte/internal");
const { createEventDispatcher, onMount, onDestroy } = require("svelte");
const { colorClasses, routerAttrs, routerClasses, actionsClasses, actionsAttrs } = require("../shared/mixins");
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (root_start_slot) {
				if (root_start_slot.p && dirty & /*$$scope*/ 524288) {
			...
			if (content_start_slot) {
				if (content_start_slot.p && dirty & /*$$scope*/ 524288) {
			...
			if (content_end_slot) {
				if (content_end_slot.p && dirty & /*$$scope*/ 524288) {
			...
			set_attributes(a, a_data = get_spread_update(a_levels, [
				(!current || dirty & /*itemRootClasses*/ 8) && { class: /*itemRootClasses*/ ctx[3] },
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (children_start_slot) {
				if (children_start_slot.p && dirty & /*$$scope*/ 524288) {
			...
			if (children_slot) {
				if (children_slot.p && dirty & /*$$scope*/ 524288) {
...
function create_fragment(ctx) {
	...
	let if_block1 = /*hasChildren*/ ctx[5] && create_if_block(ctx);
	let div_levels = [{ class: /*classes*/ ctx[2] }, restProps(/*$$restProps*/ ctx[10])];
	let div_data = {};
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		$: $$invalidate(3, itemRootClasses = classNames(
			"treeview-item-root",
			{
		...
		$: $$invalidate(4, itemRootAttrs = extend(
			{
		...
		if ($$self.$$.dirty & /*toggle, hasChildren*/ 4128) {
