/* routable-modals.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, assign, attr, binding_callbacks, check_outros, create_component, destroy_component, detach, element, empty, get_spread_object, get_spread_update, group_outros, init, insert, mount_component, outro_and_destroy_block, safe_not_equal, transition_in, transition_out, update_keyed_each } = require("svelte/internal");
const { onMount, onDestroy, afterUpdate, tick } = require("svelte");
const { f7events, f7routers } = require("../shared/f7");
...
exports.default = Routable_modals;