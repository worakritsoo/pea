/* view.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, create_component, create_slot, destroy_component, detach, element, empty, exclude_internal_props, get_spread_object, get_spread_update, group_outros, init: init_1, insert, mount_component, outro_and_destroy_block, safe_not_equal, space, transition_in, transition_out, update_keyed_each, update_slot } = require("svelte/internal");
const { onMount, onDestroy, afterUpdate, createEventDispatcher, tick } = require("svelte");
const { f7, f7ready, f7routers, f7events } = require("../shared/f7");
const { colorClasses } = require("../shared/mixins");
const { classNames, noUndefinedProps, createEmitter, getRouterId } = require("../shared/utils");
const { getRouterInitialComponent } = require("../shared/get-router-initial-component");
const { useTab } = require("../shared/use-tab");
const { default: RouterContextProvider } = require("./router-context-provider");
...
// (190:4) <RouterContextProvider route={page.props.f7route} router={page.props.f7router}>
function create_default_slot(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const switch_instance_changes = (dirty[0] & /*pages*/ 8)
...
// (189:2) {#each pages as page (page.id)}
function create_each_block(key_1, ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*pages*/ 8) routercontextprovider_changes.route = /*page*/ ctx[29].props.f7route;
			if (dirty[0] & /*pages*/ 8) routercontextprovider_changes.router = /*page*/ ctx[29].props.f7router;

			if (dirty[0] & /*$$scope, pages*/ 2056) {
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && dirty[0] & /*$$scope*/ 2048) {
