/* page-content.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, mount_component, safe_not_equal, set_attributes, space, transition_in, transition_out, update_slot } = require("svelte/internal");
...
// (130:2) {#if infinite && infiniteTop && infinitePreloader}
...
// (134:2) {#if infinite && !infiniteTop && infinitePreloader}
...
// (137:2) {#if ptr && ptrPreloader && ptrBottom}
