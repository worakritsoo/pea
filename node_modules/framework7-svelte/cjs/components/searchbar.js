/* searchbar.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_slot, detach, element, empty, exclude_internal_props, get_spread_update, group_outros, init: init_1, insert, listen, noop, run_all, safe_not_equal, set_attributes, set_data, space, text, transition_in, transition_out, update_slot } = require("svelte/internal");
const { createEventDispatcher, onMount, onDestroy } = require("svelte");
const { colorClasses } = require("../shared/mixins");
const { classNames, noUndefinedProps, createEmitter } = require("../shared/utils");
...
function create_else_block(ctx) {
	...
	const inner_start_slot = create_slot(inner_start_slot_template, ctx, /*$$scope*/ ctx[47], get_inner_start_slot_context_1);
	...
	const inner_end_slot = create_slot(inner_end_slot_template, ctx, /*$$scope*/ ctx[47], get_inner_end_slot_context_1);
	...
	const after_inner_slot = create_slot(after_inner_slot_template, ctx, /*$$scope*/ ctx[47], get_after_inner_slot_context_1);
		...
		p(ctx, dirty) {
			...
			if (inner_start_slot) {
				if (inner_start_slot.p && dirty[1] & /*$$scope*/ 65536) {
					update_slot(inner_start_slot, inner_start_slot_template, ctx, /*$$scope*/ ctx[47], dirty, get_inner_start_slot_changes_1, get_inner_start_slot_context_1);
				}
			}
			...
			if (inner_end_slot) {
				if (inner_end_slot.p && dirty[1] & /*$$scope*/ 65536) {
					update_slot(inner_end_slot, inner_end_slot_template, ctx, /*$$scope*/ ctx[47], dirty, get_inner_end_slot_changes_1, get_inner_end_slot_context_1);
				}
			}
			...
			if (after_inner_slot) {
				if (after_inner_slot.p && dirty[1] & /*$$scope*/ 65536) {
					update_slot(after_inner_slot, after_inner_slot_template, ctx, /*$$scope*/ ctx[47], dirty, get_after_inner_slot_changes_1, get_after_inner_slot_context_1);
				}
			}
...
function create_if_block(ctx) {
	...
	const inner_start_slot_template = /*#slots*/ ctx[48]["inner-start"];
	const inner_start_slot = create_slot(inner_start_slot_template, ctx, /*$$scope*/ ctx[47], get_inner_start_slot_context);
	const input_wrap_start_slot_template = /*#slots*/ ctx[48]["input-wrap-start"];
	...
	const inner_end_slot_template = /*#slots*/ ctx[48]["inner-end"];
	const inner_end_slot = create_slot(inner_end_slot_template, ctx, /*$$scope*/ ctx[47], get_inner_end_slot_context);
	const default_slot_template = /*#slots*/ ctx[48].default;
	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[47], null);
	const after_inner_slot_template = /*#slots*/ ctx[48]["after-inner"];
	...
	return {
		...
		p(ctx, dirty) {
			if (before_inner_slot) {
				if (before_inner_slot.p && dirty[1] & /*$$scope*/ 65536) {
					update_slot(before_inner_slot, before_inner_slot_template, ctx, /*$$scope*/ ctx[47], dirty, get_before_inner_slot_changes, get_before_inner_slot_context);
				}
			}

			if (inner_start_slot) {
				if (inner_start_slot.p && dirty[1] & /*$$scope*/ 65536) {
					update_slot(inner_start_slot, inner_start_slot_template, ctx, /*$$scope*/ ctx[47], dirty, get_inner_start_slot_changes, get_inner_start_slot_context);
				}
			}
			...
			if (inner_end_slot) {
				if (inner_end_slot.p && dirty[1] & /*$$scope*/ 65536) {
					update_slot(inner_end_slot, inner_end_slot_template, ctx, /*$$scope*/ ctx[47], dirty, get_inner_end_slot_changes, get_inner_end_slot_context);
				}
			}
			...
			if (after_inner_slot) {
				if (after_inner_slot.p && dirty[1] & /*$$scope*/ 65536) {
					update_slot(after_inner_slot, after_inner_slot_template, ctx, /*$$scope*/ ctx[47], dirty, get_after_inner_slot_changes, get_after_inner_slot_context);
				}
			}
