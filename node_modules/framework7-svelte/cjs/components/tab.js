/* tab.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, empty, exclude_internal_props, get_spread_object, get_spread_update, group_outros, init, insert, mount_component, safe_not_equal, set_attributes, space, transition_in, transition_out, update_slot } = require("svelte/internal");
const { onMount, onDestroy, afterUpdate, createEventDispatcher, tick, getContext } = require("svelte");
const { restProps } = require("../shared/rest-props");
const { colorClasses } = require("../shared/mixins");
const { classNames, createEmitter, getComponentId } = require("../shared/utils");
const { f7ready, f7routers, f7events } = require("../shared/f7");
