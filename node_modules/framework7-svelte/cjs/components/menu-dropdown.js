/* menu-dropdown.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, compute_rest_props, create_slot, detach, element, exclude_internal_props, get_spread_update, init, insert, safe_not_equal, set_attributes, transition_in, transition_out, update_slot } = require("svelte/internal");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*position, left, center, right*/ 240) {
			$: $$invalidate(10, positionComputed = (() => {
