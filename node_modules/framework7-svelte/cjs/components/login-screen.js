/* login-screen.svelte generated by Svelte v3.29.4 */
"use strict";
...
function instance_1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$new_props => {
		...
		if ("containerEl" in $$new_props) $$invalidate(6, containerEl = $$new_props.containerEl);
	...
	$$self.$$.update = () => {
		$: $$invalidate(1, classes = classNames(className, "login-screen", modalStateClasses(state), colorClasses($$props)));
