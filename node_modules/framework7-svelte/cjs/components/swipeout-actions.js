/* swipeout-actions.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, assign, compute_rest_props, create_slot, detach, element, exclude_internal_props, get_spread_update, init, insert, safe_not_equal, set_attributes, transition_in, transition_out, update_slot } = require("svelte/internal");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*side, left, right*/ 56) {
			...
			$: $$invalidate(8, sideComputed = side || (left ? "left" : right ? "right" : "left"));
		}
	...
	return [classes, $$restProps, className, left, right, side, $$scope, slots];
}
...
exports.default = Swipeout_actions;