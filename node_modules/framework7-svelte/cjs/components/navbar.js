/* navbar.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, mount_component, safe_not_equal, set_attributes, set_data, space, text, transition_in, transition_out, update_slot } = require("svelte/internal");
const { createEventDispatcher, onMount, onDestroy, afterUpdate } = require("svelte");
const { colorClasses } = require("../shared/mixins");
const { classNames, plainText, createEmitter } = require("../shared/utils");
const { restProps } = require("../shared/rest-props");
const { f7, f7ready } = require("../shared/f7");
const { hasSlots } = require("../shared/has-slots");
const { useTheme } = require("../shared/use-theme");
const { default: NavLeft } = require("./nav-left");
const { default: NavTitle } = require("./nav-title");
const { default: NavRight } = require("./nav-right");
...
// (198:4) {#if backLink || hasLeftSlots}
...
// (199:6) <NavLeft {backLink} {backLinkUrl} {backLinkForce} {backLinkShowText} {onBackClick}>
...
// (204:4) {#if title || subtitle || hasTitleSlots}
...
// (215:4) {#if largeTitle || hasTitleLargeSlots}
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[1] & /*theme*/ 8) {
			$: $$invalidate(41, addLeftTitleClass = theme && theme.ios && f7 && !f7.params.navbar.iosCenterTitle);
		}

		if ($$self.$$.dirty[1] & /*theme*/ 8) {
			$: $$invalidate(42, addCenterTitleClass = theme && theme.md && f7 && f7.params.navbar.mdCenterTitle || theme && theme.aurora && f7 && f7.params.navbar.auroraCenterTitle);
		}
