/* list.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, binding_callbacks, check_outros, compute_rest_props, create_slot, detach, element, empty, exclude_internal_props, get_spread_update, group_outros, init, insert, listen, safe_not_equal, set_attributes, space, transition_in, transition_out, update_slot } = require("svelte/internal");
const { createEventDispatcher, onMount, onDestroy } = require("svelte");
const { colorClasses } = require("../shared/mixins");
const { classNames, extend, createEmitter } = require("../shared/utils");
...
function create_else_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (before_list_slot) {
				if (before_list_slot.p && dirty[1] & /*$$scope*/ 4096) {
			...
			if (after_list_slot) {
				if (after_list_slot.p && dirty[1] & /*$$scope*/ 4096) {
...
function create_if_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (list_slot) {
				if (list_slot.p && dirty[1] & /*$$scope*/ 4096) {
