/* preloader.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, assign, attr, compute_rest_props, detach, element, exclude_internal_props, get_spread_update, init, insert, noop, safe_not_equal, set_attributes } = require("svelte/internal");
...
function instance($$self, $$props, $$invalidate) {
	...
	return [theme, preloaderStyle, classes, $$restProps, style, className, size];
}
