/* button.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, action_destroyer, append, assign, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, empty, exclude_internal_props, get_spread_update, group_outros, init, insert, is_function, listen, mount_component, run_all, safe_not_equal, set_attributes, set_data, space, text: text_1, transition_in, transition_out, update_slot } = require("svelte/internal");
...
const { default: Preloader } = require("./preloader");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*href*/ 131072) {
			$: $$invalidate(50, hrefComputed = href === true ? "#" : href || undefined);
		}
