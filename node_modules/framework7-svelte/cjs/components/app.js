...
const { SvelteComponent, append, assign, attr, binding_callbacks, create_component, create_slot, destroy_component, detach, element, exclude_internal_props, init, insert, mount_component, safe_not_equal, space, transition_in, transition_out, update_slot } = require("svelte/internal");
const { onMount } = require("svelte");
const { f7, f7init } = require("../shared/f7");
const { colorClasses } = require("../shared/mixins");
const { classNames, noUndefinedProps } = require("../shared/utils");
const { default: RoutableModals } = require("./routable-modals");
