/* link.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, action_destroyer, append, assign, binding_callbacks, check_outros, compute_rest_props, create_component, create_slot, destroy_component, detach, element, exclude_internal_props, get_spread_update, group_outros, init, insert, is_function, listen, mount_component, run_all, safe_not_equal, set_attributes, set_data, space, text: text_1, toggle_class, transition_in, transition_out, update_slot } = require("svelte/internal");
...
const { classNames, extend, isStringProp, plainText, createEmitter } = require("../shared/utils");
...
// (115:2) {#if typeof text !== 'undefined' || typeof badge !== 'undefined'}
...
// (118:6) {#if typeof badge !== 'undefined'}
function create_if_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*$$scope, badge*/ 16777218) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*tabbarLabel, TabbarContext*/ 67174400) {
		...
		if ($$self.$$.dirty[0] & /*iconOnly, text, hasDefaultSlots*/ 268566529) {
