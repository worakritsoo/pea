/* fab-button.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, action_destroyer, append, assign, attr, binding_callbacks, compute_rest_props, create_slot, detach, element, exclude_internal_props, get_spread_update, init, insert, is_function, listen, run_all, safe_not_equal, set_attributes, set_data, space, text, transition_in, transition_out, update_slot } = require("svelte/internal");
