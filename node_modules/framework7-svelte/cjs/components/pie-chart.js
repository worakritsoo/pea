/* pie-chart.svelte generated by Svelte v3.29.4 */
"use strict";

const { SvelteComponent, append, assign, attr, binding_callbacks, compute_rest_props, create_slot, destroy_block, detach, element, exclude_internal_props, get_spread_update, init, insert, listen, run_all, safe_not_equal, set_attributes, set_style, space, svg_element, transition_in, transition_out, update_keyed_each, update_slot } = require("svelte/internal");
const { createEventDispatcher, onDestroy } = require("svelte");
...
// (159:4) {#each paths as path, index (index)}
function create_each_block(key_1, ctx) {
	...
	function click_handler(...args) {
		return /*click_handler*/ ctx[13](/*index*/ ctx[29], ...args);
	}

	function mouseenter_handler(...args) {
		return /*mouseenter_handler*/ ctx[14](/*index*/ ctx[29], ...args);
	}
	...
	return {
		...
		c() {
			...
			attr(path, "class", path_class_value = classNames({
				"pie-chart-hidden": /*currentIndex*/ ctx[2] !== null && /*currentIndex*/ ctx[2] !== /*index*/ ctx[29]
			}));
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*currentIndex, paths*/ 20 && path_class_value !== (path_class_value = classNames({
				"pie-chart-hidden": /*currentIndex*/ ctx[2] !== null && /*currentIndex*/ ctx[2] !== /*index*/ ctx[29]
			}))) {
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*paths, classNames, currentIndex, setCurrentIndex*/ 52) {
				const each_value = /*paths*/ ctx[4];
	...
	const setCurrentIndex = index => {
		if (index === null) {
			timeout = setTimeout(() => {
				...
				$$invalidate(2, currentIndex = index);
			});
		} else {
