...
var _default = {
  proto: {
    pageComponentLoader: function pageComponentLoader(_ref) {
      ...
      _f.f7routers.views.forEach(function (data) {
      ...
      function onDidUpdate(componentRouterData) {
        ...
        _f.f7events.off('viewRouterDidUpdate', onDidUpdate);
      ...
      _f.f7events.on('viewRouterDidUpdate', onDidUpdate);
    ...
    tabComponentLoader: function tabComponentLoader(_temp) {
      ...
      _f.f7routers.tabs.forEach(function (tabData) {
      ...
      function onDidUpdate(componentRouterData) {
        ...
        _f.f7events.off('tabRouterDidUpdate', onDidUpdate);
      ...
      _f.f7events.on('tabRouterDidUpdate', onDidUpdate);
    ...
    modalComponentLoader: function modalComponentLoader(_temp2) {
      ...
      var router = this;
      var modalsRouter = _f.f7routers.modals;
      ...
      function onDidUpdate() {
        ...
        _f.f7events.off('modalsRouterDidUpdate', onDidUpdate);
      ...
      _f.f7events.on('modalsRouterDidUpdate', onDidUpdate);
